...
def main():
    ...
    my_net = GCN(in_c=in_c, hid_c=hid_c, out_c=out_c)  # Load the GCN model
    result_file = "GCN.h5"
    savefig = "GCN"
    model_path = "gcn"

    # Optionally use different models (ChebNet, GATNet)
    net = "ChebNet"  # You can change this to "GATNet" to use GATNet
    if net == "ChebNet":
        in_c = 4
        hid_c = 16
        out_c = 16
